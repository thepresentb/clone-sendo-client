...
export const Info = () => {
  return (
    <div className="bg-gray-800">
      <div className="flex flex-col sm:flex-row p-8 xl:max-w-[1100px] lg:max-w-[900px] md:max-w-[750px] mx-auto text-white text-xs">
        <div className="w-full sm:w-6/12 pr-20">
        ...
        <div className="w-full sm:w-6/12 mt-10 sm:mt-4">
          <div className="font-bold ml-3">Đăng ký nhận bản tin ưu đãi khủng từ Sendo</div>
          <div className="w-[90%] sm:w-full flex mx-2 my-2">
