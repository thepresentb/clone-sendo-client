...
export const SubNav = () => {
  // hide qr menu
  const handleHoverQr = () => {
    document.getElementById("qr-hide").classList.toggle("hidden");
  };
  return (
    <div className="h-[32px] w-full bg-red-600 leading-8 font-medium text-white text-sm">
      <div className="flex xl:max-w-[1100px] lg:max-w-[900px] md:max-w-[750px] mx-auto ">
        <div className="flex grow">
          <div className="relative pr-8" onMouseEnter={handleHoverQr} onMouseLeave={handleHoverQr}>
            ...
            <div className="absolute w-full h-10 top-[20px]"></div>
            <div
              id="qr-hide"
