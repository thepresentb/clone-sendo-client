...
export const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      >
        <a href="/" className="w-[120px] mt-1 grow sm:grow-0 h-[48px] hover:opacity-80">
        ...
        <div aria-label="tote bag" className="mt-[14px] mx-4 sm:mx-16" onClick={handleClickBag}>
          <div className="relative hover:opacity-80">
            ...
            {bag?.length !== 0 ? (
              <div className="absolute rounded-full w-[24px] border-[2px] border-red-600 bg-white top-[-8px] left-[14px] pl-[7px] text-[14px] font-semibold">
                {bag?.length}
              </div>
            ) : null}
          </div>
