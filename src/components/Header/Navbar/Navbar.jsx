...
export const Navbar = () => {
  ...
  return (
    ...
    >
      <TopNav></TopNav>
      <div
        className={`flex pt-1 xl:max-w-[1308px] lg:max-w-[900px] md:max-w-[750px] mx-auto  ${
          isCategoryPage && window.innerWidth < 640 ? "hidden" : ""
        }`}
      >
        <a href="/" className="w-[87px] mt-1 sm:grow-0 h-[48px] hover:opacity-80">
        ...
        <div class="mt-3 mr-[2px]">
          <button
            class="h-8 min-w-[101px] pb-[3px] bg-white rounded"
            onClick={() => {
              dispatch(toggleAuthenState("login"));
            }}
          >
            <span class="text-[14px] py-3 text-slate-700 font-bold whitespace-nowrap">
